...
export const metadata:Metadata={title:"David's Insurance | Auto, Home & Life",description:"Personal insurance guidance for auto, home, and life coverage in Van Nuys, California."};
